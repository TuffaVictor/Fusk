...
OnlMenu:add_action("Get Visitor Bonus Again", function() stats.set_int("MPPLY_CHIPS_COL_TIME", 0) globals.set_int(1575012, 1) globals.set_int(1574589, 1) sleep(0.2) globals.set_int(1574589, 0) end)
...
local function Fceomc(e) if not localplayer then return end if e then globals.set_int(262145 + 12972, 0) globals.set_int(262145 + 16576, 0) else globals.set_int(262145 + 12972, 50000) globals.set_int(262145 + 16576, 250000) end end OnlMenu:add_toggle("Change CEO/MC Name Free", function() return e37 end, function() e37 = not e37 Fceomc(e37) end)
...
local function BRC(e) if not localplayer then return end if e then globals.set_int(283492, 1000) globals.set_int(283493, 1000) else globals.set_int(283492, 15000) globals.set_int(283493, 15000) end end OnlMenu:add_toggle("Remove Bunker Resupply Cost", function() return e23 end, function() e23 = not e23 BRC(e23) end)
...
cayoPericoMenu:add_toggle("Remove CCTV", function() return e6 end, function() e6 = not e6 Cctv(e6) end) cayoPericoMenu:add_action("Skip Drainage cut", function() if heist_script:is_active() then if heist_script:get_int(27036) >= 3 or heist_script:get_int(27036) <= 6 then heist_script:set_int(27036, 6) end end end) cayoPericoMenu:add_action("Bypass Fingerprint Cloner ", function() if heist_script and heist_script:is_active() then if heist_script:get_int(23177) == 4 then heist_script:set_int(23177, 5) end end end)
local function QPC(e) if e then heist_script:set_float(28269 + 3, 99.9) end end cayoPericoMenu:add_toggle("Quick Plasma Cutter", function() return e19 end, function() e19 = not e19 QPC(e19) end) cayoPericoMenu:add_int_range("Cayo Lifes", 1.0, 1, 10, function() return heist_script:get_int(43059 + 865 + 1) end, function(life) if heist_script and heist_script:is_active() then heist_script:set_int(43059 + 865 + 1, life) end end) cayoPericoMenu:add_action("Kill mission npcs", function() menu.kill_all_mission_peds() end) cayoPericoMenu:add_action("Kill all npcs", function() menu.kill_all_npcs() end) cayoPericoMenu:add_action("---", function() end)
cayoPericoMenu:add_int_range("Real Take", 289700, 100000, 8691000, function() return heist_script:get_int(40004+1392+53) end, function(v) heist_script:set_int(40004+1392+53, v) end)
...
end xox_7 = value end) local cutsMenu = cayoPericoMenu:add_submenu("Cuts") cutsMenu:add_array_item("Preset cuts", {"65 all", "80 all", "90 all", "100 all", "138 all-Panther only", "202 all-PinkD only"}, function() return xox_32 end, function(G) if G == 1 then for i = 1974405, 1974408 do globals.set_int(i, 65) end elseif G == 2 then for i = 1974405, 1974408 do globals.set_int(i, 80) end elseif G == 3 then for i = 1974405, 1974408 do globals.set_int(i, 90) end elseif G == 4 then for i = 1974405, 1974408 do globals.set_int(i, 100) end elseif G == 5 then for i = 1974405, 1974408 do globals.set_int(i, 138) end elseif G == 6 then for i = 1974405, 1974408 do globals.set_int(i, 202) end end xox_32 = value end)
cutsMenu:add_int_range("Player 1", 1, 15, 300, function() return globals.get_int(1974405) end, function(value) globals.set_int(1974405, value) end) cutsMenu:add_int_range("Player 2", 1, 15, 300, function() return globals.get_int(1974406) end, function(value) globals.set_int(1974406, value) end) cutsMenu:add_int_range("Player 3", 1, 15, 300, function() return globals.get_int(1974407) end, function(value) globals.set_int(1974407, value) end) cutsMenu:add_int_range("Player 4", 1, 15, 300, function() return globals.get_int(1974408) end, function(value) globals.set_int(1974408, value) end) cutsMenu:add_int_range("Non-Host Self", 1, 15, 300, function() return globals.get_int(2722097) end, function(value) globals.set_int(2722097, value) end)
...
casinoHeistMenu:add_action("Bypass Fingerprint Hack ", function() if casinolifes and casinolifes:is_active() then if casinolifes:get_int(52899) == 4 then casinolifes:set_int(52899, 5) end end end)
casinoHeistMenu:add_action("Bypass Door Hack ", function() if casinolifes and casinolifes:is_active() then if casinolifes:get_int(53729) ~= 4 then casinolifes:set_int(53729, 5) end end end)
casinoHeistMenu:add_action("Quick Drill Vault Door", function() if casinolifes:is_active() then casinolifes:set_int(10068 + 7, 4) sleep(0.01) casinolifes:set_int(10068 + 7, 6) menu.send_key_press(1) end end)
local VLzr = casinolifes:get_int(10105) casinoHeistMenu:add_action("Quick Lazer Vault Door ", function() if casinolifes and casinolifes:is_active() then casinolifes:set_int(10075, VLzr) sleep(0.02) casinolifes:set_int(10075, 0) end end)
...
casinoHeistMenu:add_int_range("Real Take", 100000, 1000000, 10000000, function() return casinolifes:get_int(22337) end, function(v) casinolifes:set_int(22337, v) end)
local CDNCMenu = casinoHeistMenu:add_submenu("Cuts") CDNCMenu:add_array_item("Preset cuts", {"85 all", "100 all"}, function() return xox_34 end, function(G) if G == 1 then for i = 1969065, 1969068 do globals.set_int(i, 85) end elseif G == 2 then for i = 1969065, 1969068 do globals.set_int(i, 100) end end xox_34 = value end)
CDNCMenu:add_int_range("Player 1", 5, 15, 300, function() return globals.get_int(1969065) end, function(value) globals.set_int(1969065, value) end) CDNCMenu:add_int_range("Player 2", 5, 15, 300, function() return globals.get_int(1969066) end, function(value) globals.set_int(1969066, value) end) CDNCMenu:add_int_range("Player 3", 5, 15, 300, function() return globals.get_int(1969067) end, function(value) globals.set_int(1969067, value) end) CDNCMenu:add_int_range("Player 4", 5, 15, 300, function() return globals.get_int(1969068) end, function(value) globals.set_int(1969068, value) end) CDNCMenu:add_action("-----", function() end) CDNCMenu:add_int_range("Non-Host Self Cut", 5, 15, 300, function() return globals.get_int(2722097) end, function(value) globals.set_int(2722097, value) end)
local CDNPMenu = casinoHeistMenu:add_submenu("Potential Editor") CDNPMenu:add_int_range("Cash Potential", 1000000000.0, 2115000, 1000000000, function() return globals.get_int(290614) end, function(value) globals.set_int(290614, value) end) CDNPMenu:add_int_range("Art Potential", 1000000000.0, 2350000, 1000000000, function() return globals.get_int(290615) end, function(value) globals.set_int(290615, value) end) CDNPMenu:add_int_range("Gold Potential", 1000000000.0, 2580000, 1000000000, function() return globals.get_int(290616) end, function(value) globals.set_int(290616, value) end) CDNPMenu:add_int_range("Diamond Potential", 1000000000.0, 3290000, 1000000000, function() return globals.get_int(290617) end, function(value) globals.set_int(290617, value) end) 
...
mmNmenu:add_int_range("Reset Sales", 1, 0, 1000, function() return stats.get_int(mpx .. "HUB_SALES_COMPLETED") end, function(value) stats.set_int(mpx .. "HUB_SALES_COMPLETED", value) end) mmNmenu:add_int_range("Reset Earnings", 500000, 0, 30000000, function() return stats.get_int(mpx .. "HUB_EARNINGS") end, function(value) stats.set_int(mpx .. "HUB_EARNINGS", value) globals.set_int(1575012, 1) globals.set_int(1574589, 1) sleep(0.2) globals.set_int(1574589, 0) end)
...
mmHmenu:add_int_range("Reset stats-No. of Sales", 1, 0, 500, function() return stats.get_int(mpx .. "LFETIME_HANGAR_SEL_COMPLET") end, function(value) stats.set_int(mpx .. "LFETIME_HANGAR_BUY_UNDETAK", value) stats.set_int(mpx .. "LFETIME_HANGAR_BUY_COMPLET", value) stats.set_int(mpx .. "LFETIME_HANGAR_SEL_UNDETAK", value) stats.set_int(mpx .. "LFETIME_HANGAR_SEL_COMPLET", value) stats.set_int(mpx .. "LFETIME_HANGAR_EARNINGS", value * 40000) globals.set_int(1575012, 1) globals.set_int(1574589, 1) sleep(0.2) globals.set_int(1574589, 0) end)
...
local function VRC(e) if not localplayer then return end if e then globals.set_int(280893, 1000) else globals.set_int(280893, 1000) end end
...
local timeMenu = statMenu:add_submenu("Time Stats (Days)")
...
for j = 290125, 290144 do globals.set_int(j, 1) end end)
...
unlxMenu:add_array_item("Bunker Research", {"Speed Up", "Reset Speed"}, function() return xox_26 end, function(value) if value == 1 then globals.set_int(283484, 1) globals.set_int(283485, 1) globals.set_int(283486, 1) globals.set_int(283487, 1) menu.trigger_bunker_research() elseif value == 2 then globals.set_int(283484, 60) globals.set_int(283486, 45000) globals.set_int(283485, 300000) globals.set_int(283487, 45000) end xox_26 = value end)
...
local function RPB(e) if not localplayer then return end if e then globals.set_int(151761, 2) globals.set_int(102911, 90) globals.set_int(102911, 1) else globals.set_int(151761, 0) globals.set_int(102911, 0) end end tempMenu:add_toggle("Returning Player Bonus", function() return e31 end, function() e31 = not e31 RPB(e31) end)
tempMenu:add_toggle("Contract DLC Gunskins", function()	return globals.get_boolean(286133) end, function(value) globals.set_boolean(286133, value) globals.set_boolean(286134, value) end)
tempMenu:add_toggle("ContractDLC Animal Masks", function() return globals.get_boolean(293598) end, function(value) for i = 293598, 293609 do globals.set_boolean(i, value) end end)
tempMenu:add_toggle("ContractDLC DJ Cloths", function() return globals.get_boolean(293610) end, function(value) globals.set_boolean(293610, value) globals.set_boolean(293611, value) globals.set_boolean(293612, value) end)
local function AMCS(e) if not localplayer then return end if e then globals.set_int(289339, -1) globals.set_int(289340, -1) globals.set_int(289341, -1) globals.set_int(289342, -1)	else globals.set_int(289339, 0) globals.set_int(289340, 0) globals.set_int(289341, 0) globals.set_int(289342, 0) end end tempMenu:add_toggle("Ace Mask Casino Store", function() return e32 end, function() e32 = not e32 AMCS(e32) end)
local function PCS(e) if not localplayer then return end if e then for i = 290009, 290014 do globals.set_int(i, -1) end globals.set_int(289754, -1) globals.set_int(289820, -1) else for i = 290009, 290014 do globals.set_int(i, 0) end globals.set_int(289754, 0) globals.set_int(289820, 0) end end tempMenu:add_toggle("Paintings Casino Store", function() return e33 end, function() e33 = not e33 PCS(e33) end)
local function UnA(e) if not localplayer then return end if e then globals.set_int(102911, 90) else globals.set_int(102911, 0) end end tempMenu:add_toggle("Up-n-Atomizer", function() return e34 end, function() e34 = not e34 UnA(e34) end)
tempMenu:add_toggle("Festive tint", function() return globals.get_boolean(102911) end, function(value) globals.set_boolean(102911, value) end)
tempMenu:add_toggle("Valentine Unlocks", function() return globals.get_boolean(269001) end, function(value) globals.set_boolean(269001, value) globals.set_boolean(273965, value) globals.set_boolean(273966, value) globals.set_boolean(273967, value) globals.set_boolean(273968, value) globals.set_boolean(273969, value) globals.set_boolean(275331, value) globals.set_boolean(275332, value) end)
local function J4A(e) if not localplayer then return end if e then globals.set_int(270196, 1) globals.set_int(270205, 1) globals.set_int(270206, 1) for i = 270209, 270211 do for j = 270234, 270240 do globals.set_int(i, 1) globals.set_int(j, 1) end end else globals.set_int(270196, 0) globals.set_int(270205, 0) globals.set_int(270206, 0) for i = 270209, 270211 do for j = 270234, 270240 do globals.set_int(i, 0) globals.set_int(j, 0) end end end end tempMenu:add_toggle("Independance Day Unlocks", function() return e38 end, function() e38 = not e38 J4A(e38) end)
tempMenu:add_toggle("Halloween Unlocks", function() return globals.get_boolean(273931) end, function(value) globals.set_boolean(273931,value) globals.set_boolean(273971,value) globals.set_boolean(273976,value) globals.set_boolean(273977,value) globals.set_boolean(273978,value) globals.set_boolean(273980,value) globals.set_boolean(273986,value) globals.set_boolean(273987,value) globals.set_boolean(273988,value) globals.set_boolean(273994,value) globals.set_boolean(274637,value) globals.set_boolean(279433,value) end)
tempMenu:add_toggle("X-mas Unlocks", function() return globals.get_boolean(266879) end, function(value) globals.set_boolean(266879,value) globals.set_boolean(292697,value) globals.set_boolean(287643,value) globals.set_boolean(287644,value) globals.set_boolean(287645,value) globals.set_boolean(271122,value) globals.set_boolean(271386,value) globals.set_boolean(271387,value) globals.set_boolean(271388,value) globals.set_boolean(274645,value) globals.set_boolean(285326,value) globals.set_boolean(285327,value) globals.set_boolean(285328,value) globals.set_boolean(285329,value) globals.set_boolean(286117,value) globals.set_boolean(274646,value) globals.set_boolean(274648,value) globals.set_boolean(281196,value) globals.set_boolean(284970,value) globals.set_boolean(274751,value) globals.set_boolean(274752,value) globals.set_boolean(274753,value) globals.set_boolean(274754,value) globals.set_boolean(281055,value) globals.set_boolean(281056,value) globals.set_boolean(281057,value) globals.set_boolean(281058,value) globals.set_boolean(285348,value) globals.set_boolean(285349,value) globals.set_boolean(285350,value) globals.set_boolean(285351,value) globals.set_boolean(287647,value) globals.set_boolean(287648,value) globals.set_boolean(287649,value) globals.set_boolean(287650,value) globals.set_boolean(290499,value) globals.set_boolean(290500,value) globals.set_boolean(290501,value) globals.set_boolean(290502,value) globals.set_boolean(293543,value) globals.set_boolean(293544,value) globals.set_boolean(285321,value) globals.set_boolean(285322,value) globals.set_boolean(285323,value) globals.set_boolean(285324,value) globals.set_boolean(285325,value) end) 
tempMenu:add_toggle("Toggle Snow", function() return globals.get_boolean(266868) end, function(value) globals.set_boolean(266868,value) end)
tempMenu:add_toggle("Unlock Caps", function() return globals.get_boolean(283048) end, function(value) globals.set_boolean(283048,value) globals.set_boolean(283051,value) globals.set_boolean(283057,value) globals.set_boolean(283060,value) globals.set_boolean(283061,value) globals.set_boolean(283068,value) globals.set_boolean(283071,value) globals.set_boolean(283073,value) end)
tempMenu:add_toggle("Unlock Hats", function() return globals.get_boolean(274526) end, function(value) for i = 274526, 274525 do globals.set_boolean(i,value) end end)
tempMenu:add_toggle("Unlock Brand Shirts", function() return globals.get_boolean(277117) end, function(value) for i = 277117, 277119 do for j = 277121, 277123 do for k = 277125, 277131 do for l = 286119, 286122 do globals.set_boolean(i,value) globals.set_boolean(j,value) globals.set_boolean(k,value) globals.set_boolean(l,value) end end end end globals.set_boolean(286124,value) globals.set_boolean(286127,value) globals.set_boolean(286129,value) globals.set_boolean(286132,value) globals.set_boolean(270240,value) end)
...
local CREDMenu = mainMenu:add_submenu("Credits") CREDMenu:add_action("Kiddions ", function() end) CREDMenu:add_action("Boredom1234", function() end) CREDMenu:add_action("Thorben ", function() end) CREDMenu:add_action("Nyx ", function() end) CREDMenu:add_action("randomAlt69420 ", function() end) CREDMenu:add_action("jonaaa20", function() end) CREDMenu:add_action("jhowkNx ", function() end) CREDMenu:add_action("mon99 ", function() end) CREDMenu:add_action("Volkret ", function() end) CREDMenu:add_action("IceDoomfist ", function() end)